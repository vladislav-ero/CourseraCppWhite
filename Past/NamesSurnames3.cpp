...
class Person {
public:
    Person(const string& fn_at_birth, const string& ln_at_birth, const int& y_of_birth) {
        first_names[year_of_birth] = fn_at_birth;
        last_names[year_of_birth] = ln_at_birth;
        year_of_birth = y_of_birth;
    }
